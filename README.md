...
```bash
curl -fsSL -o /root/sb.sh https://raw.githubusercontent.com/mubdao/Proxy/refs/heads/main/sb.sh && bash /root/sb.sh
```
...
```bash
curl -fsSL -o /root/snell.sh https://raw.githubusercontent.com/mubdao/Proxy/refs/heads/main/snell.sh && bash /root/snell.sh
```
